...
echo ""
echo "客户端配置示例："
echo "  ~/.config/recordian/config.yaml"
echo ""
echo "  asr:"
echo "    provider: http-cloud"
echo "    endpoint: http://192.168.5.225:8000/transcribe"
echo "    timeout_s: 30"
echo ""
echo "  text_refine:"
echo "    provider: cloud-llm"
echo "    api_base: http://192.168.5.225:11434/v1"
echo "    api_key: dummy"
echo "    model: qwen2.5:7b"
echo "    api_format: openai"
echo ""
