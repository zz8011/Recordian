...
def test_voice_wake_recording_starts_owner_gate_as_active(monkeypatch) -> None:
    events: list[dict[str, object]] = []
    captured_owner_active: list[object] = []
    ...
    def _fake_start_wake_session_monitor(context):  # noqa: ANN001
    ...
    assert start_recording("voice_wake") is True
    assert captured_owner_active == [True]


def test_voice_wake_recording_enables_monitor_stream(monkeypatch) -> None:
    events: list[dict[str, object]] = []
